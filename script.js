...
console.log(superHelt.flyvehastighed);
const besked = `Min superkraft er at ${superHelt.superkraft}`;
const superheltevenner = `Den tredje superhelteven er ${superHelt.superheltevenner[2]}`;*/
